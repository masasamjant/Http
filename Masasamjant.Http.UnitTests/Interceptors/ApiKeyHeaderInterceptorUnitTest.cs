namespace Masasamjant.Http.Interceptors
{
    ...
    public class ApiKeyHeaderInterceptorUnitTest : UnitTest
    {
        ...
        public async Task Test_InterceptAsync_Get()
        {
            ...
            var interceptor = new ApiKeyHeaderInterceptor("key", "value");
